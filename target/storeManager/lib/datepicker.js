...
angular.module("datePicker").run(["$templateCache", function($templateCache) {
  ...
  $templateCache.put("templates/datepicker.html",
    ...
    "      <tr>\r" +
    "\n" +
    "        <th ng-click=\"prev()\"><i class=\"fa fa-chevron-left\"></i></th>\r" +
    "\n" +
    "        <th colspan=\"5\" class=\"switch\" ng-click=\"setView('month')\">{{date|date:\"yyyy MMMM\"}}</th>\r" +
    "\n" +
    "        <th ng-click=\"next()\"><i class=\"fa fa-chevron-right\"></i></i></th>\r" +
    "\n" +
    "      </tr>\r" +
    "\n" +
    "      <tr>\r" +
    ...
    "      <tr>\r" +
    "\n" +
    "        <th ng-click=\"prev(10)\"><i class=\"fa fa-chevron-left\"></i></th>\r" +
    "\n" +
    "        <th colspan=\"5\" class=\"switch\">{{years[0].getFullYear()}}-{{years[years.length-1].getFullYear()}}</th>\r" +
    "\n" +
    "        <th ng-click=\"next(10)\"><i class=\"fa fa-chevron-right\"></i></i></th>\r" +
    "\n" +
    "      </tr>\r" +
    "\n" +
    "      </thead>\r" +
    ...
    "      <tr>\r" +
    "\n" +
    "        <th ng-click=\"prev(24)\"><i class=\"fa fa-chevron-left\"></i></th>\r" +
    "\n" +
    "        <th colspan=\"5\" class=\"switch\" ng-click=\"setView('date')\">{{ date|date:\"dd MMMM yyyy\" }}</th>\r" +
    "\n" +
    "        <th ng-click=\"next(24)\"><i class=\"fa fa-chevron-right\"></i></i></th>\r" +
    "\n" +
    "      </tr>\r" +
    "\n" +
    "      </thead>\r" +
